...
const u8 gText_BirchInTrouble[] = _("THAT NIGGA BOUTTA DIE GANG!\nRelease a POKéMON and rescue him!");
...
const u8 gText_AnythingElseICanHelp[] = _("Is that it lil bro?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Is that it lil bro?");
...
const u8 gText_Option[] = _("OPTION MENU");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}TURTLE");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}QUICK");
